...
import (
	_ "github.com/liugangnhm/wails/v2/internal/goversion" // Add Compile-Time version check for minimum go version
	"github.com/liugangnhm/wails/v2/pkg/application"
