...
import (
	...
	"github.com/liugangnhm/wails/v2/internal/frontend/desktop/windows/win32"
	...
	"github.com/liugangnhm/wails/v2/internal/frontend/originvalidator"
	wailsruntime "github.com/liugangnhm/wails/v2/internal/frontend/runtime"
	"github.com/liugangnhm/wails/v2/internal/logger"
	w32consts "github.com/liugangnhm/wails/v2/internal/platform/win32"
	"github.com/liugangnhm/wails/v2/internal/system/operatingsystem"
	"github.com/liugangnhm/wails/v2/pkg/assetserver"
	"github.com/liugangnhm/wails/v2/pkg/assetserver/webview"
	"github.com/liugangnhm/wails/v2/pkg/options"
	"github.com/liugangnhm/wails/v2/pkg/options/windows"
	...
	mainWindow.OnSize().Bind(func(arg *winc.Event) {
		if f.frontendOptions.Frameless {
			...
			if event != nil && event.Type == w32.SIZE_MINIMIZED {
				...
				// 设置最小化标志以防止无边框窗口在最小化/恢复过程中的不必要重�?				// This fixes window flickering when minimizing/restoring frameless windows
